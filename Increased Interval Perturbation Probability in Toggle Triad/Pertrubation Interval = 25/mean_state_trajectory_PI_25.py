...
def generator(p_perturb, p_update):
    ...
    while run_loop < 100:
        ...
        while sim_time <= 1000:
            ...
            if (sim_time%5 == 0):
                p_update = np.random.normal(0.4, 0.4)
            ...
            if A == False and B == False and C == False:
                RT_000 = RT_000 + 1
                state_traj[run_loop].append(0)
            if A == False and B == False and C == True:
                RT_001 = RT_001 + 1
                state_traj[run_loop].append(1)
            if A == False and B == True and C == False:
                RT_010 = RT_010 + 1
                state_traj[run_loop].append(2)
            if A == False and B == True and C == True:
                RT_011 = RT_011 + 1
                state_traj[run_loop].append(3)
            if A == True and B == False and C == False:
                RT_100 = RT_100 + 1
                state_traj[run_loop].append(4)
            if A == True and B == False and C == True:
                RT_101 = RT_101 + 1
                state_traj[run_loop].append(5)
            if A == True and B == True and C == False:
                RT_110 = RT_110 + 1
                state_traj[run_loop].append(6)
    ...
    state_traj = mean_arr(state_traj)
    return arr_RT_000, arr_RT_001, arr_RT_010, arr_RT_011,arr_RT_100, arr_RT_101, arr_RT_110, arr_RT_111, state_A, state_B, state_C, state_traj
...
def main():
    ...
    p_perturb = 0.1
    line1,line2,line3,line4,line5,line6,line7,line8,state_A_1,state_B_1,state_C_1, state_traj_1 = generator(p_perturb, p_update)
    line1,line2,line3,line4,line5,line6,line7,line8 = mean_exp(line1,line2,line3,line4,line5,line6,line7,line8)

    p_perturb = 0.3
    line9,line10,line11,line12,line13,line14,line15,line16,state_A_3,state_B_3,state_C_3, state_traj_3 = generator(p_perturb, p_update)
    line9,line10,line11,line12,line13,line14,line15,line16 = mean_exp(line9,line10,line11,line12,line13,line14,line15,line16)

    p_perturb = 0.5
    line17,line18,line19,line20,line21,line22,line23,line24,state_A_5,state_B_5,state_C_5, state_traj_5 = generator(p_perturb, p_update)
    line17,line18,line19,line20,line21,line22,line23,line24 = mean_exp(line17,line18,line19,line20,line21,line22,line23,line24)

    p_perturb = 0.7
    line25,line26,line27,line28,line29,line30,line31,line32,state_A_7,state_B_7,state_C_7, state_traj_7 = generator(p_perturb, p_update)
    line25,line26,line27,line28,line29,line30,line31,line32 = mean_exp(line25,line26,line27,line28,line29,line30,line31,line32)

    p_perturb = 0.9
    line33,line34,line35,line36,line37,line38,line39,line40,state_A_9,state_B_9,state_C_9, state_traj_9 = generator(p_perturb, p_update)
    ...
    with open("MRT "+" output.tsv", "w") as csvfile:
        ...
        writer.writerow([])
        writer.writerow(['P_up=N(0.4,0.4)','P_perturb = 0.1'])
        ...
        writer.writerow([])
        writer.writerow(['P_up=N(0.4,0.4)','P_perturb = 0.3'])
        ...
        writer.writerow([])
        writer.writerow(['P_up=N(0.4,0.4)','P_perturb = 0.5'])
        ...
        writer.writerow([])
        writer.writerow(['P_up=N(0.4,0.4)','P_perturb = 0.7'])
        ...
        writer.writerow([])
        writer.writerow(['P_up=N(0.4,0.4)','P_perturb = 0.9'])
    ...
    dev_state_traj=[deviation(state_traj_1), deviation(state_traj_3), deviation(state_traj_5), deviation(state_traj_7), deviation(state_traj_9)]
    ...
    with open("Trajectory"+" output.tsv", "w") as csvfile:
        ...
        writer.writerow([])
        writer.writerow(['The Std.Dev','for St.Traj. for','0.1,0.3,0.5,0.7,0.9','respectively'])
        writer.writerow(dev_state_traj)
        writer.writerow([])
        ...
        writer.writerow([])
        writer.writerow([])
        writer.writerow(['Trajectory','for','St.Traj'])
        writer.writerow([])
        writer.writerow(state_traj_1)
        writer.writerow([])
        writer.writerow(state_traj_3)
        writer.writerow([])
        writer.writerow(state_traj_5)
        writer.writerow([])
        writer.writerow(state_traj_7)
        writer.writerow([])
        writer.writerow(state_traj_9)
    ...
    # plt.subplot(3,1,1)
    # plt.title("Mean Expression Level Trajectory Of Node A,B,C respectively between 400-420 for Network 0 ver 1", loc = 'center')
    ...
    #In this case we are adding noise to the update probability at every 5 seconds
    #In this case we are increasing the interval at which perturbation choice is made to 25 time steps

    plt.title("Mean State Trajectory of Nodes ", loc = 'center')
    plt.xlabel("Time")
    plt.ylabel("Mean State")
    plt.plot(sim_time,state_traj_1, '.-k', ms = 1, mec = 'r', mfc = 'r', label='P_P= 0.1')
    plt.plot(sim_time,state_traj_3, '.-g', ms = 1, mec = 'r', mfc = 'r', label='P_P= 0.3')
    plt.plot(sim_time,state_traj_5, '.-b', ms = 1, mec = 'r', mfc = 'r', label='P_P= 0.5')
    plt.plot(sim_time,state_traj_7, '.-m', ms = 1, mec = 'r', mfc = 'r', label='P_P= 0.7')
    plt.plot(sim_time,state_traj_9, '.-c', ms = 1, mec = 'r', mfc = 'r', label='P_P= 0.9')
    plt.legend()
    plt.savefig("Mean State Trajectory Output.jpg")

    # plt.title("Mean State Trajectory of Nodes ", loc = 'center')
    # plt.xlabel("Time")
    # plt.ylabel("Mean State")
    # plt.plot(sim_time,state_traj_1, '.-k', ms = 1, label='P_P= 0.1')
    # plt.plot(sim_time,state_traj_3, '.-g', ms = 1, label='P_P= 0.3')
    # plt.plot(sim_time,state_traj_5, '.-b', ms = 1, label='P_P= 0.5')
    # plt.plot(sim_time,state_traj_7, '.-m', ms = 1, label='P_P= 0.7')
    # plt.plot(sim_time,state_traj_9, '.-c', ms = 1, label='P_P= 0.9')
    # plt.legend()
    # plt.savefig("Mean State Trajectory Output.jpg")
