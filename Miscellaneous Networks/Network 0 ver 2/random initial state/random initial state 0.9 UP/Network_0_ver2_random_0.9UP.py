...
def main():
    ...
    with open("Network 0 ver2 MRT " + "p=0.9 UP perturbation " + " output.tsv", "w") as csvfile:
    ...
    with open("Network 0 ver2 Trajectory" + "p=0.9 UP perturbation " + " output.tsv", "w") as csvfile:
        writer = csv.writer(csvfile, dialect="excel-tab")
    ...
    plt.title("Mean Expression Level Trajectory Of Node A", loc = 'center')
    plt.xlabel("Time")
    ...
    plt.legend()
    plt.savefig("Node A Output.jpg")

    plt.title("Mean Expression Level Trajectory Of Node B", loc = 'center')
    plt.xlabel("Time")
    plt.ylabel("Mean expression level percentage")
    plt.plot(sim_time,state_B_1, '.-k', ms = 1, mec = 'r', mfc = 'r', label='Perturbation Probability = 0.1')
    plt.plot(sim_time,state_B_3, '.-g', ms = 1, mec = 'r', mfc = 'r', label='Perturbation Probability = 0.3')
    plt.plot(sim_time,state_B_5, '.-b', ms = 1, mec = 'r', mfc = 'r', label='Perturbation Probability = 0.5')
    plt.plot(sim_time,state_B_7, '.-m', ms = 1, mec = 'r', mfc = 'r', label='Perturbation Probability = 0.7')
    plt.plot(sim_time,state_B_9, '.-c', ms = 1, mec = 'r', mfc = 'r', label='Perturbation Probability = 0.9')
    plt.legend()
    plt.savefig("Node B Output.jpg")

    plt.title("Mean Expression Level Trajectory Of Node C", loc = 'center')
    plt.xlabel("Time")
    plt.ylabel("Mean expression level percentage")
    plt.plot(sim_time,state_C_1, '.-k', ms = 1, mec = 'r', mfc = 'r', label='Perturbation Probability = 0.1')
    plt.plot(sim_time,state_C_3, '.-g', ms = 1, mec = 'r', mfc = 'r', label='Perturbation Probability = 0.3')
    plt.plot(sim_time,state_C_5, '.-b', ms = 1, mec = 'r', mfc = 'r', label='Perturbation Probability = 0.5')
    plt.plot(sim_time,state_C_7, '.-m', ms = 1, mec = 'r', mfc = 'r', label='Perturbation Probability = 0.7')
    plt.plot(sim_time,state_C_9, '.-c', ms = 1, mec = 'r', mfc = 'r', label='Perturbation Probability = 0.9')
    plt.legend()
    plt.savefig("Node C Output.jpg")
