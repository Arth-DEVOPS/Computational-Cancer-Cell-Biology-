...
def main():
    ...
    with open("Network 0 ver1 MRT " + "p=0.9 UP perturbation " + " output.tsv", "w") as csvfile:
    ...
    with open("Network 0 ver1 Trajectory" + "p=0.9 UP perturbation " + " output.tsv", "w") as csvfile:
        writer = csv.writer(csvfile, dialect="excel-tab")
