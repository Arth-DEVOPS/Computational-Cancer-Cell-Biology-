...
def main():
    ...
    with open("TT + 2 SA ver1 MRT " + "p=0.1 UP perturbation " + " output.tsv", "w") as csvfile:
    ...
    with open("TT + 2 SA ver1 Trajectory" + "p=0.1 UP perturbation " + " output.tsv", "w") as csvfile:
        writer = csv.writer(csvfile, dialect="excel-tab")
