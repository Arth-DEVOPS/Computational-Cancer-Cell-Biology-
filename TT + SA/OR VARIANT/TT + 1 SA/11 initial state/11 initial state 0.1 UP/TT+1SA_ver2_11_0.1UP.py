...
def main():
    ...
    with open("TT + 1 SA ver2 MRT " + "p=0.1 UP perturbation " + " output.tsv", "w") as csvfile:
    ...
    with open("TT + 1 SA ver2 Trajectory" + "p=0.1 UP perturbation " + " output.tsv", "w") as csvfile:
        writer = csv.writer(csvfile, dialect="excel-tab")
